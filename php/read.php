...
$query = "Select count(*) as BrojZauzetihMjesta from studenti where Upisan=1";
$result = $oConnection->query($query);
...
$query = "Select studenti.Id,studenti.Ime,studenti.Prezime,studenti.Spol,studenti.JMBAG,studenti.OIB,studenti.Upisan from studenti LEFT JOIN studentbodovi on studentbodovi.StudentId = studenti.Id where Upisan = 0 ORDER BY studentbodovi.BrojBodova DESC;";
$result = $oConnection->query($query);
...
case 'RemoveStudentDom':
$query = "Delete from studenti where Id=".$_POST['StudentId'];
$result = $oConnection->query($query);
$query = "Delete from studentbodovi where StudentId=".$_POST['StudentId'];
$result = $oConnection->query($query);
$query = "Delete from dodatnipodacistudent where StudentId=".$_POST['StudentId'];
$result = $oConnection->query($query);
$query = "Delete from login where StudentId=".$_POST['StudentId'];
$result = $oConnection->query($query);
break;

case 'ClearRooms':
$query = "Delete from studentposobi";
$result = $oConnection->query($query);
echo json_encode("All room clear");
break;
